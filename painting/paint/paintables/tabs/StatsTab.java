 ...
 */
public class StatsTab extends PaintManager implements Paintable {

    /**
     * The master X position for the show GUI button.
     */
    private final int X = getX() + 83;
    ...
    public void draw(Graphics g) {
        ...
        final int X_DATA_PADDING = 8;
        g.drawString("Stats", X + X_DATA_PADDING, Y + Y_DATA_PADDING);
    }
